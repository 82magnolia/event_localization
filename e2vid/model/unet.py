...
from .submodules import \
    ...
    RecurrentConvLayer, ResidualBlock, ConvLSTM, ConvGRU, RecurrentResidualLayer
...
class UNetRecurrent(BaseUNet):
    ...
    def __init__(self, num_input_channels, num_output_channels=1, skip_type='sum',
        ...
        self.encoders = nn.ModuleList()
        for idx, (input_size, output_size) in enumerate(zip(self.encoder_input_sizes, self.encoder_output_sizes)):
